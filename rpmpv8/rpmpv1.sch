...
U 1 1 5A435798
P 3720 1260
F 0 "#PWR5" H 3720 1110 50  0001 C CNN
...
U 1 1 5A43A975
P 1020 1460
F 0 "#PWR3" H 1020 1310 50  0001 C CNN
...
A7
Text Label 10355 4310 0    60   ~ 0
WAIT
Text Label 10300 4940 0    60   ~ 0
BUSDIR
Text Label 10375 4625 0    60   ~ 0
INT
NoConn ~ 9470 1210
NoConn ~ 9470 1310
NoConn ~ 10770 1210
...
U 1 1 5A5C5385
P 3720 3760
F 0 "#PWR6" H 3720 3610 50  0001 C CNN
...
U 1 1 5A5C538C
P 820 6110
F 0 "#PWR2" H 820 5860 50  0001 C CNN
...
U 1 1 5A5C5393
P 1020 3960
F 0 "#PWR4" H 1020 3810 50  0001 C CNN
...
MREQ
Text Label 9205 4940 0    60   ~ 0
BDIR
Text Label 9205 4625 0    60   ~ 0
RC23
...
Wire Wire Line
	9550 4310 9055 4310
Wire Wire Line
	10200 4310 10740 4310
Wire Wire Line
	10195 4625 10725 4625
Wire Wire Line
	10195 4940 10740 4940
Wire Wire Line
	9545 4940 9025 4940
Wire Wire Line
...
F 1 "74HC04" H 5525 5765 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 5325 5865 50  0001 C CNN
F 3 "" H 5325 5865 50  0001 C CNN
	4    5325 5865
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 5ADDA9BC
P 5320 6210
F 0 "U2" H 5470 6310 50  0000 C CNN
F 1 "74HC04" H 5520 6110 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 5320 6210 50  0001 C CNN
F 3 "" H 5320 6210 50  0001 C CNN
	3    5320 6210
	1    0    0    -1  
$EndComp
$Comp
...
U 2 1 5ADDAA29
P 5315 6550
F 0 "U2" H 5465 6650 50  0000 C CNN
F 1 "74HC04" H 5515 6450 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 5315 6550 50  0001 C CNN
F 3 "" H 5315 6550 50  0001 C CNN
	2    5315 6550
	1    0    0    -1  
$EndComp
Wire Wire Line
	4475 5865 4875 5865
Text Label 4560 6210 0    60   ~ 0
IORQ
Wire Wire Line
	4470 6210 4870 6210
Text Label 4555 6550 0    60   ~ 0
nATN
Wire Wire Line
	4465 6550 4865 6550
Wire Wire Line
	5775 5865 6175 5865
Text Label 5860 6210 0    60   ~ 0
nIORQ
Wire Wire Line
	5770 6210 6170 6210
Text Label 5855 6550 0    60   ~ 0
ATN
Wire Wire Line
	5765 6550 6165 6550
$Comp
...
U 1 1 5ADDB66F
P 5310 6880
F 0 "U2" H 5460 6980 50  0000 C CNN
F 1 "74HC04" H 5510 6780 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 5310 6880 50  0001 C CNN
F 3 "" H 5310 6880 50  0001 C CNN
	1    5310 6880
	1    0    0    -1  
$EndComp
Text Label 4550 6880 0    60   ~ 0
nBDIR
Wire Wire Line
	4460 6880 4860 6880
Text Label 5850 6880 0    60   ~ 0
BDIR
Wire Wire Line
	5760 6880 6160 6880
Text Label 6590 4110 0    60   ~ 0
DAT_EN0
Wire Wire Line
	6485 4110 6885 4110
Text Label 6590 4310 0    60   ~ 0
nRC21
Wire Wire Line
	6485 4310 6885 4310
Text Label 8175 4210 0    60   ~ 0
DAT_EN
Wire Wire Line
	8085 4210 8485 4210
Wire Wire Line
	6485 4615 6885 4615
Text Label 6575 4815 0    60   ~ 0
IORQ
Wire Wire Line
	6485 4815 6885 4815
Wire Wire Line
	8085 4715 8485 4715
Text Label 6575 5125 0    60   ~ 0
nIORQ
Wire Wire Line
	6495 5125 6895 5125
Wire Wire Line
	6495 5325 6895 5325
Text Label 8145 5225 0    60   ~ 0
nBDIR
Wire Wire Line
	8615 5225 8095 5225
Wire Wire Line
...
U 5 1 5ADE5E0C
P 5315 7220
F 0 "U2" H 5465 7320 50  0000 C CNN
F 1 "74HC04" H 5515 7120 50  0000 C CNN
F 2 "" H 5315 7220 50  0001 C CNN
F 3 "" H 5315 7220 50  0001 C CNN
	5    5315 7220
	1    0    0    -1  
$EndComp
Text Label 4555 7220 0    60   ~ 0
nDIR
Wire Wire Line
	4465 7220 4865 7220
Text Label 5855 7220 0    60   ~ 0
DAT_DIR
Wire Wire Line
	5765 7220 6165 7220
...
U 1 1 5ADED653
P 7485 4210
F 0 "U6" H 7485 4260 50  0000 C CNN
F 1 "74LS08" H 7485 4160 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 7485 4210 50  0001 C CNN
F 3 "" H 7485 4210 50  0001 C CNN
	1    7485 4210
	1    0    0    -1  
$EndComp
$Comp
...
U 2 1 5ADEDD94
P 7485 4715
F 0 "U6" H 7485 4765 50  0000 C CNN
F 1 "74LS08" H 7485 4665 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 7485 4715 50  0001 C CNN
F 3 "" H 7485 4715 50  0001 C CNN
	2    7485 4715
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 5ADEDE5D
P 7495 5225
F 0 "U6" H 7495 5275 50  0000 C CNN
F 1 "74LS08" H 7495 5175 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 7495 5225 50  0001 C CNN
F 3 "" H 7495 5225 50  0001 C CNN
	3    7495 5225
	1    0    0    -1  
$EndComp
Text Label 6575 4615 0    60   ~ 0
SLTSL
Text Label 6770 3495 0    60   ~ 0
DAT_EN
Text Label 4555 5865 0    60   ~ 0
RC21
Text Label 5815 5865 0    60   ~ 0
nRC21
Text Label 8120 4715 0    60   ~ 0
DAT_EN0
Text Label 6580 5325 0    60   ~ 0
RC25
$Comp
L 74HC04 U2
U 6 1 5AEA1756
P 5315 7545
F 0 "U2" H 5465 7645 50  0000 C CNN
F 1 "74HC04" H 5515 7445 50  0000 C CNN
F 2 "" H 5315 7545 50  0001 C CNN
F 3 "" H 5315 7545 50  0001 C CNN
	6    5315 7545
	1    0    0    -1  
$EndComp
Text Label 4555 7545 0    60   ~ 0
RATN
Wire Wire Line
	4465 7545 4865 7545
Text Label 5825 7545 0    60   ~ 0
nRATN
Wire Wire Line
	5765 7545 6165 7545
$Comp
...
U 3 1 5AEDC8DE
P 9845 4940
F 0 "U5" H 10005 5040 50  0000 C CNN
F 1 "74LS07" H 10145 4880 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 9845 4940 40  0001 C CNN
F 3 "" H 9845 4940 60  0000 C CNN
	3    9845 4940
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5AEDCB0B
P 9850 4310
F 0 "U5" H 10000 4420 50  0000 C CNN
F 1 "74LS07" H 10155 4260 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 9850 4310 40  0001 R CNN
F 3 "" H 9850 4310 60  0000 C CNN
	1    9850 4310
	1    0    0    -1  
$EndComp
$Comp
...
U 2 1 5AEDCB80
P 9845 4625
F 0 "U5" H 10005 4715 50  0000 C CNN
F 1 "74LS07" H 10145 4565 50  0000 C CNN
F 2 "Housings_SOIC:SOIC-14_3.9x8.7mm_Pitch1.27mm" H 9845 4625 40  0001 C CNN
F 3 "" H 9845 4625 60  0000 C CNN
	2    9845 4625
	1    0    0    -1  
$EndComp
Text Label 6995 1615 0    60   ~ 0
RC26
Text Label 6995 2015 0    60   ~ 0
RC27
Text Label 4480 3245 0    60   ~ 0
RA10
Text Label 4475 3645 0    60   ~ 0
RA14
...
RA11
Text Label 4475 3445 0    60   ~ 0
RA12
Text Label 4480 3345 0    60   ~ 0
RA13
Text Label 4475 3545 0    60   ~ 0
RA15
Wire Wire Line
	4330 3645 4730 3645
Wire Wire Line
...
U 4 1 5B2FE1AD
P 7495 5735
F 0 "U?" H 7495 5785 50  0000 C CNN
F 1 "74LS08" H 7495 5685 50  0000 C CNN
F 2 "" H 7495 5735 50  0001 C CNN
F 3 "" H 7495 5735 50  0001 C CNN
	4    7495 5735
	1    0    0    -1  
$EndComp
Text Label 8145 5735 0    60   ~ 0
nDIR
Wire Wire Line
	8615 5735 8095 5735
Text Label 6575 5635 0    60   ~ 0
WR
Wire Wire Line
	6495 5635 6895 5635
Wire Wire Line
	6495 5835 6895 5835
Text Label 6580 5835 0    60   ~ 0
RC25
$EndSCHEMATC
